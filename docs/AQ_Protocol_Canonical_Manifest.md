...
### Entitás (DAO)
A protokoll legkisebb értelmezhető egysége az **entitás**, rövidítve **DAO**.
Egy entitás önállóan értelmezhető, megfigyelhető egység, a kontextusgráf csomópontja.

Két alaptípus:
- **Identitás DAO** — egy entitást reprezentál (egyén vagy közösség); szabadsági fokkal rendelkezik; nem származtatható.
- **Funkció DAO** — szolgáltatást, képességet vagy információ-gyűjteményt reprezentál; származtatható; hitelességet épít.

### Reláció (REL)
Két vagy több entitás közötti irányított vagy irányítatlan kapcsolat. A kontextusgráfban él formájában reprezentálva.

### Kontextusgráf (CTXG)
Egy adott értelmezési keretben releváns entitások és relációk irányított gráfja. Ez a protokoll szerinti "folyamat", "lánc" vagy "flow" általános formája — tágabb értelemben egy nem-lineáris, elágazásos kontextus.
...
### aqProtocol mint DAO
Az aqProtocol maga is egy **funkció DAO**: az első szintű (nem származtatott) funkció DAO, amely az alapvető működési logikát biztosítja. Minden további funkcionalitás származtatott DAO-kon keresztül jön létre.

Más, párhuzamos első szintű funkció DAO-k (pl. az aqProtocol független újraimplementációi) létezhetnek. Az interoperabilitás a config struktúra azonosságától függ.
...
A protokoll futtatásához szükséges a **hash → tartalom (byte)** feloldás, amelynek módja implementációfüggő. A feloldás többrétegű lehet (lokális, szerver-alapú, decentralizált tároló), a réteg a hívó szempontjából transzparens.
